...
//    mTranspose=[[Singleton sharedMySingleton].mSingltonTranspose integerValue]  ;
//	UInt32 noteCommand = kMIDIMessage_NoteOn << 4 | 0;
//
//    DLog(@"NOTE = %i",pNote+STANDART_TRANSPOSE_VALUE+mTranspose);
//	require_noerr (result = MusicDeviceMIDIEvent (self.samplerUnit, noteCommand, pNote+STANDART_TRANSPOSE_VALUE+mTranspose, onVelocity, 0), logTheError);
//logTheError:
...
//    OSStatus result = noErr;
//	require_noerr (result = MusicDeviceMIDIEvent (self.samplerUnit, noteCommand, pNote+STANDART_TRANSPOSE_VALUE+mTranspose, 0, 0), logTheError);
//
//logTheError:
