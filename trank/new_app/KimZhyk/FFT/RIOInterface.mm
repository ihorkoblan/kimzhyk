...
//		[THIS->listener frequencyChangedWithValue:freq];
        
//        [THIS->listener performSelector:NSSelectorFromString(@"frequencyChangedWithValue:") withObject:@(freq)];
        [THIS->_delegate frequencyChangedWithValue:freq];
        
        
        int n = 12 * log2f(freq / 27.5f);
		printf("frequency: %f   bin: %d  note :%i \n", freq, bin,n);
	}
